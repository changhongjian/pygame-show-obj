...
from chj.ogl import *
from chj.ogl.objloader import CHJ_tiny_obj
from chj.ogl import light


fobj="resource/BFM2017.obj"
...
'''
CHJ: The follow code is not necessary and is out of the show 3D obj task. I save this for your to learn and use one day.
'''
...
def pygame_to_cvimage(surface):
    ...
    cv_image=np.fromstring(image_string, dtype=np.uint8)
    cv_image=cv_image.reshape( (h,w,3) )

    return cv_image


def grab_pygame_image():
    #screen=param.screen
    screen = pygame.display.get_surface()

    imgdata = pygame_to_cvimage( screen )
